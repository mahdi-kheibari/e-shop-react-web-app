    ...
    >
      ...
      <Box sx={{ bgcolor: "white.main", px: 2, pb: 2 }}>
        <section>
          ...
          >
            <Grid item xs={12} md={5} sx={{ flexShrink: { md: 0 } }}>
              {windowWidth < 768 ? (
                <Box
                  className={`${style["product-information_name"]}`}
                  sx={{ mb: 2 }}
                >
                  <Typography
                    variant="h2"
              ...
              <Grid
                container
                spacing={2}
                className={`${style["view-product"]}`}
              >
                <Grid item xs={2}>
                  <Box
                    component={"ul"}
                    className={`${style["gallery-preview"]}`}
                    sx={{
                      listStyle: "none",
                      pl: 0,
                      display: "flex",
                  ...
                  >
                    {product.images.map((i) => (
                      <Box
                        ...
                        key={i.address}
                        className={`${
                          i.address === currentImg ? style["current"] : ""
                        }`}
                        sx={{ my: 2, p: 1 }}
                ...
                <Grid item xs={10}>
                  <Box className={`${style["gallery-current"]}`}>
            ...
            >
              {windowWidth >= 768 ? (
                <Box
                  ...
                  className={`${style["single-breadcrumb"]}`}
                >
                  <Breadcrumb
                    activeText={params}
                    subCrumbSingle={true}
              ...
              <Box className={`${style["product-information"]}`}>
                {windowWidth >= 768 ? (
                  <Box className={`${style["product-information_name"]}`}>
                    <Typography
                      variant="h2"
                      color="secondary"
                      className="font-24"
            ...
            <Grid
              ...
              className={`${style["position-md-sticky"]}`}
            >
              <Box className={`${style["product-information"]}`}>
                <Box
                  className={`${style["product-information-cart"]}`}
        ...
        <Container fixed>
          <Box
            component={"section"}
            className={`${style.similars} container mt-section`}
            sx={{ bgcolor: "white.main" }}
          >
            <Box
              className={`${style["similars-header"]}`}
              sx={{
                display: "flex",
                justifyContent: "space-between",
                alignItems: "baseline",
            ...
            >
              <Typography
                variant="h2"
                color="secondary"
                className={`${style["similars-title"]} font-20`}
                sx={{
                  py: 2,
                  display: "inline",
                  fontWeight: "bold",
